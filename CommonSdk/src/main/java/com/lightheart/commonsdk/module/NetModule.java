...
public class NetModule {
    ...
    @Provides
    @Singleton
    CacheInterceptor provideCacheInterceptor(BaseApplication context) {
    ...
    @Provides
    @Singleton
    OkHttpClient provideOkHttpClient(CommonInterceptor commonInterceptor, CacheInterceptor cacheInterceptor) {
        OkHttpClient.Builder builder = new OkHttpClient.Builder();
        builder.cache(new Cache(new File(BaseApplication.getApp().getFilesDir(), "HttpCache"), 1024 * 1024 * 10)).
